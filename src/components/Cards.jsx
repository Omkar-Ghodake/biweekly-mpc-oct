...
const Cards = (props) => {
    ...
    const { id, image, name, score_count, rank, pre_score, prev_team, courses } = props; // Added `courses` prop
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <div className="modal-content-container">
                        ...
                        {prev_team && <p className="score-count"><strong>Previous Team:</strong> {prev_team}</p>}
                        ...
                        <div className="course-container hover:cursor-pointer">
                            <p className="score-count ">
                                ...
                                <span className="course-tooltip "> {/* Tooltip for courses */}
                                {courses && courses.length > 0 ? (
                                    courses.map((course, index) => (
                                        <p key={index} className="course-item"style={{fontSize:"14px",color:"white"}}>{course}</p>
                                    ))
                                ) : (
